                        ...
                        <tbody>
                            <?php for ($i = 0; $i < count($same_order_sid_rows); $i++) : ?>
                                <tr>
                                    <th scope="row"><?= $i + 1 ?></th>
                                    <td>
                                        <?php if ($same_order_sid_rows[$i]['trails_sid'] === $same_trail_rows[$i]['sid']) {
                                            echo $same_trail_rows[$i]['trail_name'];
                                        } ?>
                                    </td>
                                    <td><?= $same_order_sid_rows[$i]['amount'] ?></td>
                                    <td>
                                        <?php if ($same_order_sid_rows[$i]['trails_sid'] === $same_trail_rows[$i]['sid']) {
                                    ...
                                    <td style="color: red; font-weight: bold">
                                        <?php if ($same_order_sid_rows[$i]['trails_sid'] === $same_trail_rows[$i]['sid']) {
                                            echo $same_order_sid_rows[$i]['amount'] * $same_trail_rows[$i]['price'];
                                        } ?>
                                    </td>
                                </tr>
                            <?php endfor ?>
