...
if ($isPass) {
    ...
    $sql = "UPDATE `trails` SET `trail_name`=?,`trail_img`=?,`trail_describ`=?,`trail_short_describ`=?,`trail_timetable`=?,`trail_time`=?,`geo_location_sid`=?,`difficulty_list_sid`=?,`coupon_status`=?,`price`=?,`memo`=?,`equipment`=? WHERE `sid`=?";
