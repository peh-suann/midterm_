            ...
            <div class="col-6 trails_add_card_body p-4">
                ...
                <form name="trailsform1" onsubmit="checkForm(event)">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="trail_describ" aria-describedby="emailHelp" name="trail_describ">
                        <div class="form-text"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">簡述</label>
                        <input type="text" class="form-control" id="trail_short_describ" aria-describedby="emailHelp" name="trail_short_describ">
                        <div class="form-text"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">行程規劃</label>
                        <input type="text" class="form-control" id="trail_timetable" aria-describedby="emailHelp" name="trail_timetable">
                        <div class="form-text"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">行程時長</label>
                        <input type="text" class="form-control" id="trail_time" aria-describedby="emailHelp" name="trail_time">
                        <div class="form-text"></div>
                    </div>
