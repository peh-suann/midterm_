...
<div class="container">
    <div class="mt-3 row align-items-center justify-content-between">
        ...
        <div class="col-2">
            <a style="text-decoration:none;" href="member_add.php">
                <button style="color: #fff;line-height: 1.0;" type="button" class="btn btn-info">新增會員</button>
            </a>
            ...
            <table class="table">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                                            ...
                                            <div class="modal-footer">
                                                <a id="fake-delete" style="color: #fff;text-decoration:none;" href="">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">列表中刪除</button>
                                                </a>
                        ...
                        <td>
                            <a style="color: #fff;text-decoration:none;" href="member_detail.php?sid=<?= $r['sid'] ?>">
                                <button style="line-height: 1.0;" type="button" class="btn btn-primary">詳細資料</button>
                            </a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-2">
            ...
            <a style="text-decoration:none;" href="member.php">
                <button style="color: #fff;line-height: 1.0;" type="button" class="btn btn-secondary">回列表頁</button>
            </a>
            <?php endif;
            ?>
        </div>
